...
public enum PacketType {
	LOG((byte)0), COMMAND((byte)1), INFO((byte)2), REQUEST((byte)3);
	
	private byte packetTypeByte;
	private String[] packetTypeStrings = {"LOG", "COMMAND", "INFO", "REQUEST"};
	...
	public static PacketType getPacketTypeFromByte(byte b){
		...
		throw new IllegalArgumentException("Byte doesn't represent PacketType");
	}
